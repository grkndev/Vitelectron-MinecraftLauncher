...
let Utils$6 = class Utils {
   ...
   */
  getAppDataFolder() {
    return this.getOS() === "win" ? process.env.APPDATA + "" : this.getOS() === "mac" ? process.env.HOME + "/Library/Application Support" : process.env.HOME + "";
  }
  /**
...
async function launchMinecraft() {
  ...
  try {
    ...
    launcher2.on("launch_debug", (e) => console.log(e));
    launcher2.on("launch_data", (e) => console.log(e));
    launcher2.on("launch_download", (e) => console.log(e));
  } catch (e) {
    console.log(e);
  }
}
